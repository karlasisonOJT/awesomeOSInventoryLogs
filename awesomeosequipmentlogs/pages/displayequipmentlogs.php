...
<div>
 	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method = "post" >
 		<input type="text" id="equipmentlogsearchbox" name="tosearchequipmentlog" placeholder = "Search Equipment Log" onkeyup= "getequipmentlog(this.value)" value="<?php echo $tosearch;?>" required>
